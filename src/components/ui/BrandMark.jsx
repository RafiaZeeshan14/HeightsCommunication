...
export default function BrandMark({ compact = false }) {
  return (
    <a className="relative block h-14 w-28 shrink-0 overflow-visible sm:h-14 sm:w-32 lg:h-14 lg:w-36" href="/#home" aria-label="Heights Communications home">
      <Image className="absolute left-0 top-1/2 h-20 w-auto -translate-y-1/2 drop-shadow-[0_12px_20px_rgba(0,90,255,0.28)] sm:h-22 lg:h-24" src="/logo.webp" alt="" aria-hidden="true" width={144} height={96} priority />
      {!compact && (
